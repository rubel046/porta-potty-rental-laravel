    ...
    <div class="relative bg-white rounded-3xl shadow-2xl max-w-lg w-full overflow-hidden animate-scale-in"
        ...
        <div class="p-8 text-center">
            ...
            <p class="text-slate-600 mb-6">
                <?php echo str_replace('%DISCOUNT%', '<span class="text-emerald-600 font-bold">' . $discount . '%</span>', $message); ?>
...
<?php /**PATH /Users/hasanulrubel/Playground/PPC/laravel porta potty/porta-potty-app/resources/views/components/exit-intent-popup.blade.php ENDPATH**/ ?>