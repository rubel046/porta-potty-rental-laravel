...
@section('title', 'Privacy Policy | Plumbing Pro')
@section('meta_description', 'Privacy Policy for Plumbing Pro. Learn how we collect, use, and protect your information when you use our plumbing services.')
        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <ul class="space-y-2 text-slate-600">
                    ...
                    <li class="flex items-start gap-2">
                        <span class="text-blue-500 mt-1">&#x2713;</span>
                        Details about your service inquiry
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-500 mt-1">&#x2713;</span>
            ...
            <div class="mb-10">
                ...
                <ul class="space-y-2 text-slate-600">
                    ...
                    <li class="flex items-start gap-2">
                        <span class="text-blue-500 mt-1">&#x2713;</span>
                        Connect you with a local plumbing provider
                    </li>
                    <li class="flex items-start gap-2">
                        <span class="text-blue-500 mt-1">&#x2713;</span>
            ...
            <div class="mb-10">
                <h2 class="text-2xl font-bold text-slate-800 mb-4 flex items-center gap-3">
                    <span class="w-8 h-8 bg-blue-100 rounded-lg flex items-center justify-center text-blue-600 text-sm">5</span>
                    Data Security
                </h2>
                <p class="text-slate-600 leading-relaxed">
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-8 md:p-10 text-white">
                ...
                <a href="tel:{{ domain_phone_raw() }}"
                   data-tracking-label="privacy-cta"
