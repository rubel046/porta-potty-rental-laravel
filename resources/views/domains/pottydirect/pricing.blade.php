...
$localBusinessSchema = [
    ...
    "@id" => $url . "#business",
    "name" => "Potty Direct",
    "description" => "Affordable portable restroom rental service across the USA. Same-day delivery available.",
    "url" => $url,
    "telephone" => $phone,
    "priceRange" => "$$",
    "areaServed" => [
...
<section class="py-12 px-4">
    <div class="max-w-4xl mx-auto text-center">
        ...
        <p class="text-slate-600 leading-relaxed">
            ...
            Call us at <a href="tel:{{ domain_phone_raw() }}" class="text-amber-600 font-semibold hover:underline">{{ domain_phone_display() }}</a> for a free, personalized quote.
        </p>
    </div>
</section>
