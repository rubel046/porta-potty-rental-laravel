...
<a href="#main" class="sr-only focus:not-sr-only focus:fixed focus:top-2 focus:left-2 focus:z-[10000] focus:px-4 focus:py-2 focus:bg-emerald-600 focus:text-white focus:rounded-lg focus:shadow-lg">
...
<div id="announcement-banner" class="bg-gradient-to-r from-amber-500 to-amber-600 text-white py-2 px-3 sm:px-4">
    <div class="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-1.5 sm:gap-2 text-xs sm:text-sm">
        ...
        @endif
        <a href="tel:{{ $phoneRaw }}" data-tracking-label="banner" class="ml-0 sm:ml-2 bg-white hover:bg-amber-50 text-amber-600 hover:text-amber-700 px-3 sm:px-3 py-1.5 sm:py-1 rounded-full font-bold transition text-sm sm:text-sm whitespace-nowrap shadow-sm inline-flex items-center gap-1.5 min-h-[44px]">
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-14 sm:h-16 lg:h-18">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2 sm:gap-3 group flex-shrink-0 my-1">
                <div class="w-9 h-9 sm:w-10 sm:h-10 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center shadow-lg shadow-emerald-500/30 group-hover:scale-105 transition-transform">
                ...
                <div class="hidden sm:block">
                    <div class="text-sm font-bold text-slate-800 leading-tight">{{ $domain?->business_name ?? 'Potty Direct' }}</div>
                    <div class="text-xs text-emerald-600 font-medium leading-tight">{{ $domain?->primary_service ?? 'Portable Restrooms' }}</div>
                </div>
            </a>
            ...
            <nav class="hidden lg:flex items-center gap-1">
                ...
                <div class="relative" @click.away="services = false">
                    <button type="button"
                        ...
                        Services
                        <svg aria-hidden="true" class="w-4 h-4 transition-transform" :class="services ? 'rotate-180' : ''" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div x-show="services"
                        ...
                        <div class="bg-white rounded-xl shadow-xl shadow-slate-200/50 border border-slate-100 py-2 w-56">
                            <a href="{{ route('services') }}" class="flex items-center gap-3 px-4 py-3 text-sm text-emerald-600 font-medium hover:bg-emerald-50 transition border-b border-slate-100 min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#standard" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#deluxe" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#ada" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#luxury" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#shower" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                            ...
                            <a href="{{ route('services') }}#construction" class="flex items-center gap-3 px-4 py-3 text-sm text-slate-600 hover:text-emerald-600 hover:bg-emerald-50 transition min-h-[44px]">
                                <x-icon name="building" class="w-5 h-5 flex-shrink-0 text-emerald-500" />
                                <div>
            ...
            <div class="hidden md:flex items-center flex-1 max-w-xs mx-4 lg:mx-6">
                <div class="relative w-full">
                    <input type="text" id="header-search" data-locations-url="{{ route('locations') }}" placeholder="Search city or zip..."
                    ...
                    <svg aria-hidden="true" class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="flex items-center gap-1 sm:gap-2">
                <a href="tel:{{ $phoneRaw }}" data-tracking-label="header" class="flex items-center gap-1.5 sm:gap-2 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-white text-xs sm:text-sm font-bold py-2 px-2.5 sm:px-4 rounded-full shadow-lg shadow-amber-500/25 hover:shadow-amber-500/40 transition-all hover:scale-105 ring-2 ring-amber-400/30 min-h-[44px]"
                   aria-label="Call {{ $phoneDisplay }}">
                    <svg aria-hidden="true" class="w-3.5 h-3.5 sm:w-4 sm:h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <button type="button"
                        ...
                        aria-label="Menu">
                    <svg x-show="!mobileMenu" class="w-5 h-5 sm:w-6 sm:h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path>
                    </svg>
                    <svg x-show="mobileMenu" x-cloak class="w-5 h-5 sm:w-6 sm:h-6 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-show="mobileMenu"
         ...
         class="lg:hidden fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[9998]"
    ...
    <aside x-show="mobileMenu"
           ...
           class="lg:hidden fixed inset-y-0 right-0 w-[85vw] max-w-sm bg-white z-[9999] shadow-2xl flex flex-col">
        ...
        <div class="flex items-center justify-between p-4 border-b border-slate-200 flex-shrink-0">
            <a href="{{ route('home') }}" @click="mobileMenu = false" class="flex items-center gap-2.5">
                <div class="w-9 h-9 bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-lg flex items-center justify-center shadow-md">
                ...
                <div>
                    <div class="text-sm font-bold text-slate-800 leading-tight">{{ $domain?->business_name ?? 'Potty Direct' }}</div>
                    <div class="text-[10px] text-emerald-600 font-medium leading-tight">{{ $domain?->primary_service ?? 'Portable Restrooms' }}</div>
                </div>
            </a>
            <button type="button"
                    @click="mobileMenu = false"
                    class="w-10 h-10 rounded-lg hover:bg-slate-100 flex items-center justify-center text-slate-500 hover:text-slate-700 transition focus-visible:ring-2 focus-visible:ring-emerald-500"
        ...
        {{-- Sticky phone CTA at top --}}
        <div class="px-4 py-3 bg-slate-50 border-b border-slate-200 flex-shrink-0">
            <a href="tel:{{ $phoneRaw }}"
               data-tracking-label="mobile-menu-top"
               class="flex items-center justify-center gap-2 w-full bg-amber-500 hover:bg-amber-400 text-white font-bold text-base py-3 px-5 rounded-full shadow-lg shadow-amber-500/30 ring-2 ring-amber-400/30 transition hover:scale-[1.02] active:scale-[0.98] min-h-[44px]">
                <x-icon name="phone" class="w-5 h-5" />
                <span>{{ $phoneDisplay }}</span>
            </a>
            <p class="text-[11px] text-center text-slate-500 mt-1.5">Answered in under 30 seconds</p>
        </div>
        ...
        <nav class="flex-1 overflow-y-auto py-2" aria-label="Primary navigation">
            ...
            <div x-data="{ open: @json($isRoute('services')) }" class="mx-2 my-0.5">
                <button type="button"
                    ...
                    <x-icon name="chevron-down" class="w-4 h-4 transition-transform duration-200" x-bind:class="open && 'rotate-180'" />
                </button>
                <div x-show="open" x-collapse x-cloak>
                    <div class="pl-10 pr-2 py-1 space-y-0.5">
                        <a href="{{ route('services') }}#standard" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">Standard Units</a>
                        <a href="{{ route('services') }}#deluxe" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">Deluxe Flushable</a>
                        <a href="{{ route('services') }}#ada" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">ADA Accessible</a>
                        <a href="{{ route('services') }}#luxury" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">Luxury Trailers</a>
                        <a href="{{ route('services') }}#shower" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">Portable Showers</a>
                        <a href="{{ route('services') }}#construction" @click="mobileMenu = false" class="block px-3 py-2.5 text-sm text-slate-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition min-h-[44px]">Construction Packages</a>
                        <a href="{{ route('services') }}" @click="mobileMenu = false" class="flex items-center gap-1 px-3 py-2.5 text-sm font-medium text-emerald-600 hover:text-emerald-700 rounded-lg transition min-h-[44px]">
                            View all services
            ...
            <div class="px-6 pb-2 space-y-0.5">
                <a href="{{ route('privacy') }}" @click="mobileMenu = false" class="block py-2 text-xs text-slate-500 hover:text-slate-700 transition">Privacy Policy</a>
                <a href="{{ route('terms') }}" @click="mobileMenu = false" class="block py-2 text-xs text-slate-500 hover:text-slate-700 transition">Terms of Service</a>
            </div>
        </nav>
    ...
    <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 pb-10 md:pb-12 border-b border-slate-700/60">
            ...
            <div class="lg:col-span-1">
                <div class="flex items-center gap-3 mb-5">
                    ...
                    <div>
                        ...
                        <div class="text-emerald-400 text-xs font-medium">{{ $domain?->primary_service ?? 'Portable Restrooms' }}</div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="#" class="w-9 h-9 bg-slate-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition" aria-label="Facebook">
                        <svg aria-hidden="true" class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                    </a>
                    <a href="#" class="w-9 h-9 bg-slate-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition" aria-label="Instagram">
                        <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                    </a>
                    <a href="#" class="w-9 h-9 bg-slate-800 hover:bg-emerald-600 rounded-lg flex items-center justify-center transition" aria-label="LinkedIn">
                        <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                    </a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="space-y-4">
                    <a href="tel:{{ $phoneRaw }}" data-tracking-label="footer" class="flex items-center gap-3 text-sm text-slate-400 hover:text-white transition group">
                    ...
                    <div class="flex items-center gap-3 text-sm text-slate-400">
                        <div class="w-9 h-9 bg-slate-800 rounded-lg flex items-center justify-center">
                            <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
                        </div>
                        <div>
                    ...
                    <div class="flex items-center gap-3 text-sm text-slate-400">
                        <div class="w-9 h-9 bg-slate-800 rounded-lg flex items-center justify-center">
                            <svg aria-hidden="true" class="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/></svg>
                        </div>
...
<div class="fixed left-4 right-4 md:hidden z-50" style="bottom: calc(1rem + env(safe-area-inset-bottom, 0px));">
    <a href="tel:{{ $phoneRaw }}"
       ...
       class="flex items-center justify-center gap-3 bg-gradient-to-r from-amber-500 to-amber-600 text-white font-bold text-lg py-4 px-6 rounded-2xl shadow-2xl shadow-amber-500/40 ring-4 ring-amber-400/30 transition-all hover:scale-[1.02] active:scale-[0.98] min-h-[44px]">
        <svg aria-hidden="true" class="w-6 h-6 animate-pulse" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
