...
<div class="flex h-screen overflow-hidden">
    ...
    <div x-data="{ mobileOpen: false }"
        ...
        <aside x-show="mobileOpen"
            ...
            <nav style="flex: 1 1 0%; overflow-y: auto; padding-top: 1rem; padding-bottom: 1rem;">
                ...
                <a href="{{ route('admin.states.index') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.states.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path></svg>
                    <span>States</span>
                </a>

                <a href="{{ route('admin.cities.index') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.cities.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                ...
                <a href="{{ route('admin.reports') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.reports') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                    <span>Reports</span>
                </a>

                <a href="{{ route('admin.calls.index') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.calls.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                    <span>All Calls</span>
                </a>

                <a href="{{ route('admin.logs.index') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.logs.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                ...
                <a href="{{ route('admin.api-keys.index') }}" @click="$dispatch('close-mobile-menu')" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.api-keys.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
    ...
    <aside class="w-64 bg-slate-900 text-white flex-shrink-0 hidden md:flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4 space-y-1">
            ...
            <a href="{{ route('admin.states.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.states.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"></path></svg>
                <span>States</span>
            </a>

            <a href="{{ route('admin.cities.index') }}" class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg {{ request()->routeIs('admin.cities.*') ? 'bg-green-600/20 text-green-400' : 'text-slate-300 hover:bg-slate-800/50' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path></svg>
                <span>Cities</span>
            </a>
