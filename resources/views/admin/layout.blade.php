    ...
    <aside class="w-64 bg-slate-900 text-white flex-shrink-0 flex flex-col hidden md:flex">
        ...
        <nav class="flex-1 overflow-y-auto py-4 space-y-1">
            ...
            <a href="{{ route('admin.logs.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.logs.*') ? 'bg-green-600/20 text-green-400 border-r-0' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
            ...
            <a href="{{ route('admin.api-keys.index') }}"
               class="flex items-center gap-3 px-4 py-2.5 text-sm mx-2 rounded-lg transition-all duration-200 {{ request()->routeIs('admin.api-keys.*') ? 'bg-green-600/20 text-green-400 border-r-0' : 'text-slate-300 hover:bg-slate-800/50 hover:text-white' }}">
