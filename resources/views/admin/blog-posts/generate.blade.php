...
<div class="max-w-2xl" x-data="{
    ...
    populateForm(data) {
        ...
        document.querySelector('[name=focus_keyword]').value = data.focus_keyword || '';
        document.querySelector('[name=blog_category_id]').value = data.blog_category_id || '';
        document.querySelector('[name=city_id]').value = data.city_id || '';
        
        document.getElementById('generatedData').value = JSON.stringify(data);
    }
}">
