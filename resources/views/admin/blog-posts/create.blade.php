    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-4">
        ...
        <div class="grid md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="featured_image" value="{{ old('featured_image') }}" placeholder="e.g., pottydirect/blog-images/photo.jpg" class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm font-mono">
            </div>
            <div class="md:col-span-2">
