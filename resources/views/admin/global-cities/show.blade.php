...
<div class="grid lg:grid-cols-4 gap-6">
    <div class="lg:col-span-3 space-y-6">
        ...
        {{-- Generation Status --}}
        <div id="generation-progress" class="{{ $generationStatus === 'processing' ? '' : 'hidden' }} bg-white rounded-xl shadow-sm border border-indigo-200 p-4">
            ...
            <div class="w-full bg-indigo-100 rounded-full h-3">
                <div id="progress-bar" class="bg-purple-600 h-3 rounded-full transition-all duration-300" style="width: {{ $generationProgress }}%"></div>
            </div>
            @if($startedAt)
...
<script>
    ...
    document.getElementById('generate-form')?.addEventListener('submit', function(e) {
        if (!confirm('Are you sure you want to generate content? This will create service pages, FAQs, and testimonials.\n\nExisting pages will be updated if they have the same slug.')) {
            e.preventDefault();
            return;
        }
