...
@section('content')
<form method="POST" action="{{ route('admin.global.states.store') }}" class="max-w-2xl">
    @csrf
        ...
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code') }}" required maxlength="2" placeholder="FL"
                ...
                <div>
                    ...
                    <input type="text" name="slug" value="{{ old('slug') }}" required placeholder="florida"
                        class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 px-4 py-2.5 border">
                </div>
            </div>
            ...
            <div>
                ...
                <input type="text" name="timezone" value="{{ old('timezone') }}" placeholder="America/New_York"
                    class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 px-4 py-2.5 border">
            </div>
        </div>
