...
<div class="space-y-6">
    ...
    <div class="flex gap-4 overflow-x-auto pb-2">
        <a href="{{ route('admin.service-pages.index') }}" class="bg-white rounded-xl p-5 border border-gray-100 hover:border-purple-200 hover:shadow-md transition-all duration-200 group flex-1 min-w-[200px]">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-purple-600">{{ $resourceStats['published_pages'] }}</div>
                    <div class="text-sm text-gray-500">Cities Generated</div>
                </div>
            </div>
        </a>
        <a href="{{ route('admin.service-pages.index') }}" class="bg-white rounded-xl p-5 border border-gray-100 hover:border-blue-200 hover:shadow-md transition-all duration-200 group flex-1 min-w-[200px]">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-blue-600">{{ $resourceStats['generated_states'] }}</div>
                    <div class="text-sm text-gray-500">States Generated</div>
                </div>
            </div>
        </a>
        <a href="{{ route('admin.service-pages.index') }}" class="bg-white rounded-xl p-5 border border-gray-100 hover:border-indigo-200 hover:shadow-md transition-all duration-200 group flex-1 min-w-[200px]">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-2xl font-bold text-indigo-600">{{ $resourceStats['indexed_links'] }}</div>
                    <div class="text-sm text-gray-500">Indexed Links</div>
                </div>
            </div>
        </a>
        <a href="{{ route('admin.phone-numbers.index') }}" class="bg-white rounded-xl p-5 border border-gray-100 hover:border-emerald-200 hover:shadow-md transition-all duration-200 group flex-1 min-w-[200px]">
            <div class="flex items-center gap-4">
        ...
        <a href="{{ route('admin.buyers.index') }}" class="bg-white rounded-xl p-5 border border-gray-100 hover:border-orange-200 hover:shadow-md transition-all duration-200 group flex-1 min-w-[200px]">
            <div class="flex items-center gap-4">
