...
@php
    // Heroicons outline, 24×24, stroke 1.5. Aim for visual consistency across the site.
    // Adding a new icon: copy the SVG path from https://heroicons.com and add a case below.
    $paths = [
        ...
        'test' => '<path d="M12 6v12" stroke="red"/>',
        ...
        'shield-check' => '<path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75 11.25 15 15 9.75m-3-7.036A11.959 11.959 0 0 1 3.598 6 11.99 11.99 0 0 0 3 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.623 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285Z"/>',
        ...
        'briefcase' => '<path stroke-linecap="round" stroke-linejoin="round" d="M20.25 14.15v4.073a2.25 2.25 0 0 1-1.632 2.163 48.13 48.13 0 0 1-13.236 0 2.25 2.25 0 0 1-1.632-2.163V14.15M20.25 8.507H3.75m16.5 0V6.75A2.25 2.25 0 0 0 18 4.5H6A2.25 2.25 0 0 0 3.75 6.75v1.757m16.5 0a48.674 48.674 0 0 0-16.5 0"/>',
        ...
        'water-drop' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 21a9 9 0 0 0 9-9c0-2.9-1.5-5.9-3.7-8.5A13 13 0 0 0 12 0a13 13 0 0 0-5.3 3.5A12 12 0 0 0 3 12a9 9 0 0 0 9 9Z"/>',
        'bolt' => '<path stroke-linecap="round" stroke-linejoin="round" d="M3.75 13.5 14.25 3 12 10.5h8.25L9.75 21l2.25-7.5H3.75Z"/>',
        ...
        'accessibility' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z"/>',
        'shower' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 3v3m0 12v3M5.636 5.636l2.121 2.121M16.243 16.243l2.121 2.121M3 12h3m12 0h3M5.636 18.364l2.121-2.121M16.243 7.757l2.121-2.121"/>',
        ...
        'fire' => '<path stroke-linecap="round" stroke-linejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.601a8.983 8.983 0 0 1 3.361-6.867 8.21 8.21 0 0 1 3 2.48Z"/><path stroke-linecap="round" stroke-linejoin="round" d="M12 18a3.75 3.75 0 0 0 .495-7.467 5.99 5.99 0 0 0-1.925 3.546 5.974 5.974 0 0 1-2.133-1A3.75 3.75 0 0 0 12 18Z"/>',
        ...
        'currency-dollar' => '<path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2c1.2 1 3.8 1 5 0s1.2-2.6 0-3.6-3.8-1-5-2  -1.2-2.6 0-3.6 3.8-1 5 0"/>',
    ];
